...
const product = {
  ...
  origin: "đồng nai",
  description:
    "Chất thịt tươi mới, giàu dinh dưỡng. Bởi có hương vị thịt béo hài hòa đặc trưng nên ba rọi rất được ưa chuộng để chế biến nhiều món ngon hấp dẫn như luộc, chiên, nướng... đều tuyệt vời.",
};
...
const ReviewProduct = () => {
  ...
  return (
    <div className="review-product">
      <Navbar />
      <div className="review-product-fluid">
