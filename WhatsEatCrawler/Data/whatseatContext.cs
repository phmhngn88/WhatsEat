...
namespace WhatsEatCrawler.Data
{
    public partial class whatseatContext : DbContext
    {
        public whatseatContext()
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseMySql("server=localhost;database=whatseat;user=root;password=1234;default command timeout=0", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.28-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.InStock).HasDefaultValueSql("'500'");

                entity.Property(e => e.Name).HasColumnType("longtext");

                entity.Property(e => e.ProductCategoryId).HasDefaultValueSql("'1'");
